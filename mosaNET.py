...
#model_nameee = "openai/whisper-tiny"

#sfeatureEX = AutoFeatureExtractor.from_pretrained(model_nameee)
#whisper = WhisperModel.from_pretrained(model_nameee)
...
def train(finetune_from_checkpoint,outdir):
    ...
    trainlist = '/home/rrfaustino/fineTune/Treinoo2.txt'
    validlist = '/home/rrfaustino/fineTune/Vall2.txt'
    
    whisper_trainlist = '/home/rrfaustino/fineTune/TreinoWhiss.txt'
    whisper_vallist = '/home/rrfaustino/fineTune/VallWhis.txt'
    ...
    for epoch in range(1,26):
        ...
        for i, data in enumerate(validloader, 0):            
            inputs, lps, whisper, labels_quality, labels_intell = data
            inputs , lps , whisper , labels_quality = data 
            inputs = inputs.to(device)
            lps = lps.to(device)  
...
def testing(my_checkpoint):
    ...
    Test_List=ListRead('/home/rrfaustino/fineTune/Testt2.txt')
    Test_Whisper_dir = '/home/rrfaustino/fineTune/TesttWhiss.txt'
